    ...
    <>
      ...
      <section style={{ marginLeft: "280px" }}>
        <Routes>
          ...
          <Route path="/DashboardView" element={<> <SideMenuBar /> <DashboardNav/> <Home/></>}/>
          <Route path="/categoryadd" element={<>  <SideMenuBar /> <DashboardNav title="Category Add"/> <CreateCategory /> </>}/>
          <Route path="/subcategory" element={<> <SideMenuBar /> <DashboardNav  title="Sub-Category Add"/> <SubCategory /> </>} />
          <Route path="/productAdd" element={<> <SideMenuBar /> <DashboardNav  title="Product Add"/> <ProductAdd /></>} />
